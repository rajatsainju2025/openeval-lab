            ...
            try:
                ...
                if key in self._metadata:
                    ...
                    self._metadata[key] = SecretMetadata(
                        ...
                        created_at=now,
                        last_rotated=now,
                        rotation_interval_days=metadata.get('rotation_days', 30) if metadata else 30,
...
class SecurityAuditor:
    ...
    def log_event(self, event_type: str, resource: str, action: str, 
                  result: str, user: Optional[str] = None, details: Optional[Dict] = None,
                  severity: str = "INFO"):
            ...
            with open(self.audit_log_path, 'r') as f:
                for line in f:
                    try:
                        ...
                        if entry['event_type'] == 'SECRET_ACCESS' and entry.get('details', {}).get('access_count', 0) > 100:
                            violations.append({
