...
def traced(name: Optional[str] = None, tracer_name: str = "default"):
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            tracer.trace(f"{trace_name}_start", {"args_count": len(args), "kwargs_count": len(kwargs)})
...
def profiled(name: Optional[str] = None, profiler_name: str = "default", include_args: bool = False):
