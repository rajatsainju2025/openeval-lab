...
class PluginValidator:
    ...
    def __init__(self, security_manager: Optional[RealSecurityManager] = None):
        ...
        self.required_files = {"plugin.json", "__init__.py"}  # Plugin manifest  # Python package
    ...
    async def validate_plugin(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            validation_result["valid"] = (
                ...
                and validation_result["manifest_valid"]
                and validation_result["security_score"] >= 80.0
    ...
    async def _validate_structure(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        result = {"structure_valid": False, "structure_errors": []}
    ...
    async def _validate_manifest(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        result = {"manifest_valid": False, "manifest_errors": [], "manifest": None}
        ...
        try:
            ...
            if "plugin_type" in manifest_data:
                try:
                    ...
                    result["manifest_errors"].append(
                        f"Invalid plugin_type: {manifest_data['plugin_type']}"
                    )
            ...
            if "version" in manifest_data and HAS_PACKAGING:
                try:
                    ...
                    result["manifest_errors"].append(
                        f"Invalid version format: {manifest_data['version']}"
                    )
    ...
    async def _security_scan(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        result = {"security_score": 0.0, "security_issues": [], "security_warnings": []}
    ...
    async def _check_code_quality(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        result = {"code_quality_score": 0.0, "quality_issues": []}
    ...
    async def _check_documentation(self, plugin_path: Path) -> Dict[str, Any]:
        ...
        result = {"documentation_score": 0.0, "documentation_issues": []}
    ...
    def _calculate_overall_score(self, validation_result: Dict[str, Any]) -> float:
        ...
        weights = {"structure": 0.2, "security": 0.4, "code_quality": 0.2, "documentation": 0.2}
...
class PluginRepository:
    ...
    async def submit_plugin(self, plugin_path: Path, author_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {"success": False, "plugin_name": "", "validation_result": {}, "message": ""}
        ...
        try:
            ...
            version = PluginVersion(
                ...
                security_scan=(
                    ...
                    else SecurityScanResult.WARNING
                ),
            ...
            # Record metrics
            record_metric(
                "plugin_submitted", 1, "counter", {"plugin_type": manifest.plugin_type.value}
            )
            log_event(
                "info",
                f"Plugin submitted: {plugin_name}",
    ...
    def search_plugins(
        ...
        for plugin in self.plugins.values():
            ...
            if relevance_score > 0:
                results.append(
                    PluginSearchResult(
                        plugin=plugin, relevance_score=relevance_score, match_reasons=match_reasons
                    )
                )
    ...
    async def install_plugin(
        self, name: str, version: Optional[str] = None, install_path: Optional[Path] = None
    ) -> Dict[str, Any]:
        """Install a plugin."""
        result = {"success": False, "message": "", "installed_path": None}
        ...
        try:
            ...
            result["success"] = True
            result["message"] = (
                f"Plugin '{name}' version '{plugin_version.version}' installed successfully"
            )
    ...
    def add_review(
        ...
        record_metric(
            "plugin_review_added", 1, "counter", {"plugin": plugin_name, "rating": rating}
        )
    ...
    def _save_manifest(self, manifest: PluginManifest):
        ...
        for version in manifest_dict["versions"]:
            version["release_date"] = (
                ...
                if isinstance(version["release_date"], datetime)
        ...
        for version in manifest_dict["versions"]:
            if "security_scan" in version:
                version["security_scan"] = (
                    version["security_scan"].value
                    if hasattr(version["security_scan"], "value")
                    else version["security_scan"]
                )
...
class PluginManager:
    ...
    def add_review(self, plugin_name: str, reviewer: str, rating: int, review_text: str) -> bool:
