...
class PromptTemplate:
    ...
    def __init__(self, template: str, template_type: str = "auto"):
        ...
        if self.template_type == "jinja2" and not JINJA2_AVAILABLE:
            raise ImportError(
                "jinja2 is required for Jinja2 templates. Install with: pip install jinja2"
            )
...
def build_prompt(
    template: Union[str, PromptTemplate], variables: Dict[str, Any], template_type: str = "auto"
) -> str:
    """
