    ...
    def _initialize_tasks(self):
        ...
        self.register_task(
            ...
            spec={
                ...
                "dataset_kwargs": {"path": "examples/mcqa_toy.jsonl"},
                "metrics": [
                    {"name": "openeval.metrics.loglik_accuracy:LogLikelihoodAccuracy"}
                ]
            }
        )
        ...
        self.register_task(
            ...
            spec={
                ...
                "metrics": [
                    {"name": "openeval.metrics.rouge:ROUGEL"}
                ]
            }
        )
...
NLP_BASICS_SUITE = BenchmarkSuite(
    "nlp_basics",
    ["qa_basic", "mcqa_standard", "summarization_rouge"],
    [0.4, 0.3, 0.3]
)

CODE_SUITE = BenchmarkSuite(
    "code_generation",
    ["code_humaneval", "code_basic"],
    [0.8, 0.2]
)
