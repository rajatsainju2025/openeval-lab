...
class MockDataset(Dataset):
    ...
    def __iter__(self):
        for i in range(self.size):
            yield Example(id=f"test_{i}", input=f"test_input_{i}", reference=f"test_output_{i}")
...
def test_multi_seed_evaluation():
    ...
    config = ExperimentConfig(
        name="test_multi_seed", description="Test multi-seed evaluation", random_seeds=[1, 2, 3]
    )
...
def test_aggregate_multi_seed_results():
    ...
    config = ExperimentConfig(
        name="test_aggregate", description="Test aggregation", random_seeds=[1, 2, 3]
    )
...
def test_pairwise_statistical_test():
    ...
    config = ExperimentConfig(
        name="test_pairwise", description="Test pairwise comparison", random_seeds=[1, 2, 3]
    )
...
def test_comprehensive_statistical_analysis():
    ...
    config = ExperimentConfig(
        name="test_comprehensive", description="Test comprehensive analysis", random_seeds=[1, 2, 3]
    )
...
def test_generate_experiment_id():
    ...
    config = ExperimentConfig(
        name="test_experiment", description="Test description", random_seeds=[1, 2, 3]
    )
...
def test_save_experiment_result(tmp_experiment_runner):
    ...
    config = ExperimentConfig(name="test_save", description="Test saving", random_seeds=[1])
