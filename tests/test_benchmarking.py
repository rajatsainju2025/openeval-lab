...
class TestBenchmarkDataClasses:
    ...
    def test_comparison_result_creation(self):
        ...
        result = ComparisonResult(
            ...
            statistical_significance={"accuracy": {"gpt-4_vs_claude-3": 0.05}},
...
class TestBenchmarkRunner:
    ...
    def test_benchmark_runner_with_config(self):
        ...
        config = {"warmup_iterations": 5, "benchmark_iterations": 10, "timeout": 300}
...
class TestRegressionDetector:
    ...
    def test_regression_detector_analyze_results(self):
        ...
        current_results = {"latency": 150.0, "accuracy": 0.85, "memory_usage": 512.0}

        baseline_results = {"latency": 120.0, "accuracy": 0.87, "memory_usage": 480.0}
