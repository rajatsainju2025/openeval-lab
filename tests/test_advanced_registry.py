...
class TestComponentMetadata:
    ...
    def test_metadata_compatibility_check(self):
        ...
        comp1 = ComponentMetadata(
            name="comp1", display_name="Component 1", description="Test",
            version="1.0.0", import_path="test.comp1"
        )
        
        comp2 = ComponentMetadata(
            name="comp2", display_name="Component 2", description="Test",
            version="1.0.0", import_path="test.comp2"
        )
...
class TestDependencyResolver:
    ...
    def mock_registry(self):
        ...
        comp_a = ComponentMetadata(
            name="comp_a", display_name="Component A", description="Test A",
            version="1.0.0", import_path="test.a"
        )
        comp_a.add_dependency("comp_b", ">=1.0", DependencyType.REQUIRED)
        
        comp_b = ComponentMetadata(
            name="comp_b", display_name="Component B", description="Test B",
            version="1.1.0", import_path="test.b"
        )
        comp_b.add_dependency("comp_c", ">=1.0", DependencyType.OPTIONAL)
        
        comp_c = ComponentMetadata(
            name="comp_c", display_name="Component C", description="Test C",
            version="1.0.0", import_path="test.c"
        )
...
class TestAdvancedRegistry:
    ...
    def test_list_components_no_filter(self, temp_registry):
        ...
        metadata1 = ComponentMetadata(
            name="comp1", display_name="Component 1", description="Test 1",
            version="1.0.0", import_path="test.comp1"
        )
        metadata2 = ComponentMetadata(
            name="comp2", display_name="Component 2", description="Test 2",
            version="1.0.0", import_path="test.comp2",
            status=ComponentStatus.EXPERIMENTAL
        )
    ...
    def test_list_components_with_filters(self, temp_registry):
        ...
        metadata1 = ComponentMetadata(
            name="stable-comp", display_name="Stable Component", description="Stable test",
            version="1.0.0", import_path="test.stable",
            status=ComponentStatus.STABLE, category="nlp", tags=["production"]
        )
        metadata2 = ComponentMetadata(
            name="exp-comp", display_name="Experimental Component", description="Experimental test",
            version="0.1.0", import_path="test.experimental",
            status=ComponentStatus.EXPERIMENTAL, category="vision", tags=["research"]
        )
    ...
    def test_search_components(self, temp_registry):
        ...
        metadata1 = ComponentMetadata(
            name="nlp-processor", display_name="NLP Text Processor", 
            description="Natural language processing component for text analysis",
            version="1.0.0", import_path="nlp.processor",
            keywords=["nlp", "text", "processing"], tags=["natural-language"]
        )
        metadata2 = ComponentMetadata(
            name="image-classifier", display_name="Image Classification Model",
            description="Deep learning model for image classification tasks",
            version="1.0.0", import_path="vision.classifier",
            keywords=["vision", "classification", "deep-learning"], tags=["computer-vision"]
        )
...
class TestRegistryPerformanceAndEdgeCases:
    ...
    def test_dependency_resolution_caching(self):
        ...
        try:
            ...
            comp_c = ComponentMetadata(
                name="comp-c", display_name="Component C", description="Base component",
                version="1.0.0", import_path="test.c"
            )
            comp_b = ComponentMetadata(
                name="comp-b", display_name="Component B", description="Middle component",
                version="1.0.0", import_path="test.b"
            )
            comp_b.add_dependency("comp-c", ">=1.0", DependencyType.REQUIRED)
            
            comp_a = ComponentMetadata(
                name="comp-a", display_name="Component A", description="Top component",
                version="1.0.0", import_path="test.a"
            )
