...
class TestValidationFramework:
    ...
    def setup_method(self):
        ...
        self.valid_spec = {
            "task": "qa",
            "dataset": {"name": "jsonl", "path": "test_data.jsonl"},
            "adapter": {"name": "echo"},
    ...
    def test_validate_valid_spec_file(self):
        ...
        result = self.runner.invoke(
            app, ["validate-comprehensive", str(spec_file), "--type", "spec"]
        )
    ...
    def test_validate_nonexistent_file(self):
        ...
        result = self.runner.invoke(
            app, ["validate-comprehensive", "nonexistent_file.json", "--type", "spec"]
        )
    ...
    def test_validate_dataset_type(self):
        ...
        result = self.runner.invoke(
            app, ["validate-comprehensive", str(dataset_file), "--type", "dataset"]
        )
    ...
    def test_validate_config_type(self):
        ...
        config_data = {"defaults": {"concurrency": 1, "cache": "off"}}
        with open(config_file, "w") as f:
            yaml.dump(config_data, f)

        result = self.runner.invoke(
            app, ["validate-comprehensive", str(config_file), "--type", "config"]
        )
...
class TestValidationIntegration:
    ...
    def test_validation_script_integration(self):
        ...
        with patch("subprocess.run") as mock_run:
            ...
            result = self.runner.invoke(
                app, ["validate-comprehensive", "test_spec.json", "--type", "spec"]
            )
...
pytestmark = [pytest.mark.validation, pytest.mark.cli]
