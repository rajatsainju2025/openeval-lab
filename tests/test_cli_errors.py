...
class TestCLIErrorHandling:
    ...
    def test_output_directory_permissions(self):
        ...
        result = self.runner.invoke(app, ['run', 'examples/qa_spec.json', '--artifacts', '/root/invalid'])
        assert result.exit_code != 0 or "permission" in result.output.lower() or "error" in result.output.lower()
